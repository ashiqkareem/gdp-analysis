...
correlationLblT1.grid(column=0, row=0, padx=5, pady=20, sticky="w")
...
mobLblT1.grid(column=0, row=8, padx=10, pady=8, sticky="w")
...
# Create tab3 frames
topFrameT3 = Frame(tab3, width=800, height=160, bg="lightblue")
topFrameT3.grid(columnspan=3, row=0)
midFrameT3 = Frame(tab3, width=800, height=400, bg="lightgreen")
midFrameT3.grid(columnspan=3, row=2)
botFrameT3 = Frame(tab3, width=800, height=110, bg="salmon")
